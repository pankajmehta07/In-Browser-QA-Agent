...
The same prompt is used for every model. No model gets extra context.

## Template

You are a QA instruction parser.
...
Input:
Go to Login. Type user@example.com into Email. Click Login.
